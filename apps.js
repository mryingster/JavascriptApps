...
const apps = [
    ...
    { "name" : "Bezier",               "location" : "bezier",                  "category" : "Demo",      "icon" : "icon_bezier",    "status" : COMPLETE,    "description" : "Bezier Curve Demo that visually shows how b&eacute; curves are constructed." },
    ...
    { "name" : "Sorty",                "location" : "sorty",                   "category" : "Demo",      "icon" : "icon_sorty",     "status" : COMPLETE,    "description" : "Demonstration that attempts to animate various methods of sorting arrays." },
    ...
    { "name" : "Cone Test",            "location" : "eyetest/cone.html",       "category" : "Medical",   "icon" : "icon_conetest",  "status" : DEVELOPMENT, "description" : "Eye test that checks for cone sensitivity to red, green, and blue wavelengths. Novelty use only, not to be used as a diagnosis tool." },
    { "name" : "Ephemidraw",           "location" : "draw",                    "category" : "Toys",      "icon" : "icon_missing",   "status" : DEVELOPMENT, "description" : "Drawing, but ephemerally" },
    { "name" : "Hearing Test",         "location" : "hearingtest/index.html",  "category" : "Medical",   "icon" : "icon_hearing",   "status" : DEVELOPMENT, "description" : "Hearing test is a pure tone audiometry test designed to find sensitivity to frequencies in the normal rang eof hearing. Novelty use only, not to be used as a diagnosis tool." },
    ...
    { "name" : "Ishihara Test",        "location" : "eyetest/color.html",      "category" : "Medical",   "icon" : "icon_ishihara",  "status" : DEVELOPMENT, "description" : "Randomly generated Ishihara images for testing Red/Green color blindness. Novelty use only, not to be used as a diagnosis tool." },
    ...
    { "name" : "Peripheral Test",      "location" : "eyetest/peripheral.html", "category" : "Medical",   "icon" : "icon_peripheral","status" : DEVELOPMENT, "description" : "Eye test that checks for peripheral vision sensitivity. Novelty use only, not to be used as a diagnosis tool." },
