...
const apps = [
    ...
    { "name" : "Hearing Test",         "location" : "hearingtest/index.html",  "category" : "Medical",   "icon" : "icon_missing",   "status" : DEVELOPMENT, "description" : "Hearing test is a pure tone audiometry test designed to find sensitivity to frequencies in the normal rang eof hearing. Novelty use only, not to be used as a diagnosis tool." },
