const apps = [
    ...
    { "name" : "CandyRain",            "location" : "candyrain",               "category" : "Games",     "icon" : "icon_candyrain", "status" : DEVELOPMENT, "description" : "Good and Plenties are so good they deserve their own game" },
    ...
    { "name" : "Hue're Adorable",      "location" : "gradient",                "category" : "Games",     "icon" : "icon_hue",       "status" : COMPLETE,    "description" : "A simple game where you reconstruct a gradient that's been split into pieces and shuffled." },
    { "name" : "Icony",                "location" : "resedit",                 "category" : "Utilities", "icon" : "icon_icony",     "status" : DEVELOPMENT, "description" : "Draw pixelated icons as if you are using ResEdit!" },
    ...
    { "name" : "N-Tris",               "location" : "tetris",                  "category" : "Games",     "icon" : "icon_ntris",     "status" : COMPLETE,    "description" : "Tetris clone that uses all possible shapes using up to 5 blocks." },
